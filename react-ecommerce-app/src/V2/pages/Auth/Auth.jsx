...
const AuthQuote = () => {
    return (
        <blockquote>
            <h3 className="h2 mb-4">The warmth beauty of relaxation through a perfect and convenient
                shopping experience</h3>
            <footer>— <cite className="text-lg">Desmond Brown</cite></footer>
        </blockquote>
    )
}
...
const Auth = props => {
    ...
    return (
        <div>
            <Header colorVariant={'light'} topbar={false}/>
            {
                        ...
                        <div className="main-content">
                            <section className="slice slice-lg min-vh-100 d-flex align-items-center bg-section-secondary">
                                ...
                                <div className="container py-5 px-md-0 d-flex align-items-center">
                                    <div className="w-100">
                                        <div
                                            className="row row-grid justify-content-center justify-content-lg-between align-items-center">
                                                <div className="col-sm-8 col-lg-6 col-xl-5 order-lg-2">
                                                    <div className="card shadow zindex-100 mb-0">
                                                        <div className="card-body px-md-5 py-5">
                                                            <div className="mb-5">
                                                                <h6 className="h3">{props.title}</h6>
                                                                <p className="text-muted mb-0">{props.subTitle}</p>
                                                            </div>
                                                            <span className="clearfix"></span>
                                                            {props.children}
                                                        </div>
                                                        <div className="card-footer px-md-5"><small>{props.footerText}</small> <Link
                                                            to={props.footerLink} className="small font-weight-bold">{props.footerActionText}</Link>
                                                        </div>
                                                    </div>
                                                </div>
